...
var propTypes = {
  ...
  color: _propTypes.default.oneOf(['primary', 'success', 'info', 'warning', 'danger', 'inverse', 'faded']),

  /** . */
  role: _propTypes.default.string,

  /** . */
  toggleable: _propTypes.default.oneOfType([_propTypes.default.bool, _propTypes.default.string]),
...
function (_React$Component) {
  ...
  _createClass(NavbarUnstyled, [{
    ...
    value: function render() {
      ...
      var classes = (0, _mapToCssModules.default)((0, _classnames.default)(className, 'navbar', getToggleableClass(toggleable), (_cn = {
        'navbar-light': light,
...
_defineProperty(NavbarUnstyled, "propTypes", propTypes);

_defineProperty(NavbarUnstyled, "defaultProps", defaultProps);

;
var Navbar = (0, _styledComponents.default)(NavbarUnstyled).withConfig({
  displayName: "Navbar",
  componentId: "sc-1o0l5dr-0"
})(["", ""], function (props) {
