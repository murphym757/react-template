...
var propTypes = {
  ...
  theme: _propTypes.default.shape({
    '$small-font-size': _propTypes.default.string
  }),
...
function (_React$Component) {
  ...
  _createClass(SmallUnstyled, [{
    ...
    value: function render() {
      ...
      var classes = (0, _mapToCssModules.default)((0, _classnames.default)(className, color ? "text-".concat(color) : false), cssModule);
      return _react.default.createElement("small", _extends({
        className: classes
      }, attributes), children);
    }
  }]);
...
_defineProperty(SmallUnstyled, "defaultProps", defaultProps);

var Small = (0, _styledComponents.default)(SmallUnstyled).withConfig({
  displayName: "Small",
  componentId: "jvnv75-0"
})(["", ""], function (props) {
