...
function (_React$Component) {
  ...
  _createClass(NavLink, [{
    ...
    value: function render() {
      ...
      var classes = (0, _mapToCssModules.default)((0, _classnames.default)(className, 'nav-link', {
...
_defineProperty(NavLink, "propTypes", propTypes);

_defineProperty(NavLink, "defaultProps", defaultProps);
