  ...
  _createClass(CardBlock, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(Tag, _extends({
        className: (0, _mapToCssModules.default)((0, _classnames.default)(className, 'card-block'), cssModule)
      }, attributes));
    }
  }]);
...
_defineProperty(CardBlock, "propTypes", propTypes);

_defineProperty(CardBlock, "defaultProps", defaultProps);

CardBlock.defaultProps = defaultProps;
CardBlock.propTypes = propTypes;
var _default = CardBlock;
