  ...
  _createClass(CardFooter, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(Tag, _extends({
        className: (0, _mapToCssModules.default)((0, _classnames.default)(className, 'card-footer'), cssModule)
      }, attributes));
    }
  }]);
...
_defineProperty(CardFooter, "propTypes", propTypes);

_defineProperty(CardFooter, "defaultProps", defaultProps);
