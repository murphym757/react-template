...
function (_React$Component) {
  ...
  _createClass(ListGroupItemText, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)(className, 'list-group-item-text');
...
_defineProperty(ListGroupItemText, "propTypes", propTypes);

_defineProperty(ListGroupItemText, "defaultProps", defaultProps);
