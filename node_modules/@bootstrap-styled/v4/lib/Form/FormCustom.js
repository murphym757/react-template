...
function (_React$Component) {
  ...
  _createClass(FormCustom, [{
    ...
    value: function render() {
      ...
      var CustomInput = radio ? _react.default.createElement(_Input.default, _extends({
      ...
      }, attributes)) : _react.default.createElement(_Input.default, _extends({
        defaultChecked: defaultChecked,
        checked: checked,
        type: "checkbox",
        className: "custom-control-input"
      ...
      return _react.default.createElement(_Label.default, {
        className: classes
      }, CustomInput, _react.default.createElement("span", {
