...
function (_React$Component) {
  ...
  _createClass(UlUnstyled, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)(className, inline ? 'list-inline' : false, unstyled ? 'list-unstyled' : false);
