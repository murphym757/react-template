  ...
  _createClass(CardDeckUnstyled, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(Tag, _extends({
        className: (0, _mapToCssModules.default)((0, _classnames.default)(className, 'card-deck'), cssModule)
      }, attributes));
    }
  }]);
...
_defineProperty(CardDeckUnstyled, "propTypes", propTypes);

_defineProperty(CardDeckUnstyled, "defaultProps", defaultProps);

var CardDeck = (0, _styledComponents.default)(CardDeckUnstyled).withConfig({
  displayName: "CardDeck",
  componentId: "hiovo2-0"
})(["", ""], function (props) {
