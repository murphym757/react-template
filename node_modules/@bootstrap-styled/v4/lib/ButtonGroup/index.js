  ...
  _createClass(ButtonGroupUnstyled, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(Tag, _extends({
        className: (0, _mapToCssModules.default)((0, _classnames.default)(className, vertical ? 'btn-group-vertical' : 'btn-group', _defineProperty({}, "btn-group-".concat(size), size)), cssModule)
      }, attributes));
    }
  }]);
...
var ButtonGroup = (0, _styledComponents.default)(ButtonGroupUnstyled).withConfig({
  displayName: "ButtonGroup",
  componentId: "sc-1wk454k-0"
})(["", "  "], function (props) {
