  ...
  _createClass(CardText, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(Tag, _extends({
        className: (0, _mapToCssModules.default)((0, _classnames.default)(className, 'card-text'), cssModule)
      }, attributes));
    }
  }]);
...
_defineProperty(CardText, "propTypes", propTypes);

_defineProperty(CardText, "defaultProps", defaultProps);
