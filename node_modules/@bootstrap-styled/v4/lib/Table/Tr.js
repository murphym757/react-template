...
var propTypes = {
  ...
  color: _propTypes.default.oneOf(['active', 'success', 'info', 'warning', 'danger', ''])
};
...
function (_React$Component) {
  ...
  _createClass(Tr, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)(className, _defineProperty({}, "table-".concat(color), color));
...
_defineProperty(Tr, "propTypes", propTypes);
